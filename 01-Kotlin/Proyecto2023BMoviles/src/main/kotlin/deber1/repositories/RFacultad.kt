...
object RFacultad {
    ...
    fun getAll(): List<Facultad> {
        return facultades.toList()
    }

    fun getByUniversidadId(universidadId: Int): List<Facultad> {
        return facultades.filter { it.idUniversidad == universidadId }
    }

    fun getById(id: Int): Facultad? {
