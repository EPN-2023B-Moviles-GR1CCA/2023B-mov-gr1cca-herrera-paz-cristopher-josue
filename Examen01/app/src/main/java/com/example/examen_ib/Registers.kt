...
class Registers {
    companion object{
        ...
        init{
            ...
            UBDD.TablaUniversidad!!.crearFacultad(2,"Departamento de Ciencias de la Energía y Mecánica","4","40000","true")

            // Universidades - Facultades
            arregloUniversidadesFacultades.add(UniversidadesFacultades(1,1,1))

            arregloUniversidadesFacultades.add(UniversidadesFacultades(2,2,2))
